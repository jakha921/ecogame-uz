...
### [x] 11.3 Написать Главу 2 — Проектная часть
...
### [x] 11.6 Написать Заключение, Список литературы, Приложения
...
### [x] 14.4 Google промпт на MainMenu для неавторизованных пользователей
...
### [x] 15.1 Удалить дублирующий achievements.json
...
### [x] 15.2 Удалить мёртвый App.css
...
### [x] 15.3 Исправить количество тестов (81 → 136+)
...
### [x] 15.4 Исправить CORS_ALLOWED_ORIGINS в .env
...
### [x] 15.5 Задокументировать legacy модели в game/models.py
...
### [x] 15.6 Полный прогон тестов и линтера

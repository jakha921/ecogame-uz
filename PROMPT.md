...
### [ ] 1.1 Инициализировать Git-репозиторий и базовые файлы
...
### [ ] 1.2 Настроить Django-проект (backend)
...
### [ ] 1.3 Настроить React-проект (frontend)
...
### [ ] 1.4 Создать Docker-конфигурацию для разработки
...
### [ ] 2.1 Создать приложение accounts с моделью Player
...
### [ ] 2.2 Создать модели игровой логики (Level, EcoAction, GameSession, GameProgress, ActionLog)
...
### [ ] 2.3 Создать модели Achievement, Education, Leaderboard
...
### [ ] 2.4 Настроить Unfold Admin для всех моделей
...
### [ ] 2.5 Создать фикстуры с контентом на узбекском языке
...
### [ ] 3.1 Создать API аутентификации
...
### [ ] 3.2 Написать тесты для API аутентификации
...
### [ ] 4.2 Создать сериализаторы и вьюхи для Game API
...
### [ ] 4.4 Написать тесты для Game API и запустить полный набор
...
### [ ] 5.2 Создать Zustand stores и i18n
...
### [ ] 5.3 Настроить роутинг и создать Layout, страницы
...
### [ ] 8.1 Реализовать систему достижений и уведомлений
...
### [ ] 8.2 Создать карты для всех 4 уровней и добавить звуки
...
### [ ] 8.3 Полировка UI, responsive дизайн, финальный E2E тест
...
### [ ] 9.2 Настроить GitHub репозиторий и задеплоить через Coolify
...
### [ ] 10.1 Написать Главу 1 ВКР: Аналитическая часть
